class script(object):
    START_TXT = """Salut😘 {},
𝙼𝙾𝙽 𝙽𝙾𝙼 𝙴𝚂𝚃 <a href=https://t.me/{}>{}</a>, 𝙹𝙴 𝙿𝙴𝚄𝚇 𝚃𝙴 𝙵𝙾𝚄𝚁𝙽𝙸𝚁 𝙳𝙴𝚂 𝙵𝙸𝙻𝙼𝚂 𝙴𝚃 𝙳𝙴𝚂 𝚂𝙴𝚁𝙸𝙴𝚂, 𝙸𝙻 𝚂𝚄𝙵𝙵𝙸𝚃 𝙳𝙴 𝙼’𝙰𝙹𝙾𝚄𝚃𝙴𝚁 À 𝚃𝙾𝙽 𝙶𝚁𝙾𝚄𝙿𝙴 𝙴𝚃 𝙳𝙴 𝙿𝚁𝙾𝙵𝙸𝚃𝙴𝚁 😍"""
    HELP_TXT = """𝙷𝙴𝚈 {}
𝚅𝙾𝙸𝙲𝙸 𝙻’𝙰𝙸𝙳𝙴 𝙿𝙾𝚄𝚁 𝙼𝙴𝚂 𝙲𝙾𝙼𝙼𝙰𝙽𝙳𝙴𝚂."""
    ABOUT_TXT = """✯ 𝙼𝙾𝙽 𝙽𝙾𝙼: {}
✯ 𝙲𝚁É𝙰𝚃𝙴𝚄𝚁: <a href=https://t.me/Philanthrpe><b><i>🐿💈 🅜🅐🅣🅡🅘🅧 💈🐿</i></b></a>
✯ 𝙻𝙸𝙱𝚁𝙰𝚁𝚈: 𝙿𝚈𝚁𝙾𝙶𝚁𝙰𝙼
✯ 𝙻𝙰𝙽𝙶𝚄𝙰𝙶𝙴: 𝙿𝚈𝚃𝙷𝙾𝙽 𝟹
✯ 𝙳𝙰𝚃𝙰 𝙱𝙰𝚂𝙴: 𝙼𝙾𝙽𝙶𝙾 𝙳𝙱
✯ 𝙱𝙾𝚃 𝚂𝙴𝚁𝚅𝙴𝚁: 𝙷𝙴𝚁𝙾𝙺𝚄
✯ 𝙱𝚄𝙸𝙻𝙳 𝚂𝚃𝙰𝚃𝚄𝚂: v1.0.1 [ 𝙱𝙴𝚃𝙰 ]"""
    SOURCE_TXT = """<b>NOTE:</b>
- Bᴇʟʟᴇ Aʟɪᴄᴇ est un projet Open Source. 
- Vous pouvez demandez le lien de prise en charge ci-dessous 👇👇
...
- Le filtre est la fonctionnalité où les utilisateurs peuvent définir des réponses automatisées pour un mot-clé particulier et Belle Alice répondra chaque fois qu’un mot-clé est trouvé le message
...
<code>[Button Text](buttonalert:Ceci est un message d'alerte)</code>"""
...
3. Transférez-moi le dernier message avec citations.
 J’ajouterai tous les fichiers de ce canal à mon db."""
...
Ajouté par - {}
"""
    LOG_TEXT_P = """#Nᴏᴜᴠᴇᴀᴜ ᴜᴛɪʟɪsᴀᴛᴇᴜʀ
ID - <code>{}</code>
Nom - {} à démarré Bᴇʟʟᴇ Aʟɪᴄᴇ
"""
